...
Load metadata
```{r}
meta <- read.delim(paste0("dataset_ID_metadata_", dataset_number, ".tsv")) %>% filter(str_detect(sample_name, "pt11827")) %>% mutate(amr_cov_filter=5) 
```
...
plot_heatmap(amr_subset, "gene_name", "amr_species", "AMR_confidence", col_fun_t4, 0, NULL, T, "plot_App3_pt11827_AMR.pdf")
